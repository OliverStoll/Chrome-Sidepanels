...
favicon.rel = 'icon';
favicon.href = 'https://raw.githubusercontent.com/OliverStoll/better-local-explorer/main/res/launcher.ico';
...
var items = [
  ...
  {text:"PYCHARM", link: "file:///C:/Users/Oliver/Pycharm/"},
];
...
rows.forEach(row => {
  let folder = row.querySelector('a')
...
// focus first element that is not .hidden
const firstElement = document.querySelector('#tbody td[data-value] a:not(.hidden)');
if (firstElement) {
  firstElement.focus();
}
